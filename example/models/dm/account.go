// Code generated by SQLBoiler 4.17.1 (https://github.com/aarondl/sqlboiler). DO NOT EDIT.
...
var AccountWhere = struct {
	...
	CreatedBy: whereHelperstring{field: "\"account\".\"created_by\""},
...
type accountR struct {
	CreatedByCauser *Causer     `boil:"CreatedByCauser" json:"CreatedByCauser" toml:"CreatedByCauser" yaml:"CreatedByCauser"`
...
func (r *accountR) GetCreatedByCauser() *Causer {
	if r == nil {
		return nil
	}
	return r.CreatedByCauser
}

func (r *accountR) GetCausers() CauserSlice {
	if r == nil {
		return nil
	}
	return r.Causers
...
var (
	accountAllColumns            = []string{"id", "email", "password", "created_at", "created_by", "updated_at", "deleted_at"}
	accountColumnsWithoutDefault = []string{"email", "password", "created_by"}
...
func (o *Account) Causers(mods ...qm.QueryMod) causerQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"causer\".\"account_id\"=?", o.ID),
	)

	return Causers(queryMods...)
}

// LoadCreatedByCauser allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for an N-1 relationship.
func (accountL) LoadCreatedByCauser(ctx context.Context, e boil.ContextExecutor, singular bool, maybeAccount interface{}, mods queries.Applicator) error {
	var slice []*Account
	var object *Account
	...
	query := NewQuery(
		qm.From(`causer`),
		qm.WhereIn(`causer.id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if err = results.Close(); err != nil {
		return errors.Wrap(err, "failed to close results of eager load for causer")
	}
	...
	if singular {
		...
		object.R.CreatedByCauser = foreign
		if foreign.R == nil {
			foreign.R = &causerR{}
		}
		foreign.R.CreatedByAccounts = append(foreign.R.CreatedByAccounts, object)
		return nil
	}
	...
	for _, local := range slice {
		for _, foreign := range resultSlice {
			if local.CreatedBy == foreign.ID {
				local.R.CreatedByCauser = foreign
				if foreign.R == nil {
					foreign.R = &causerR{}
				}
				foreign.R.CreatedByAccounts = append(foreign.R.CreatedByAccounts, local)
				break
			}
		}
	}
...
func (accountL) LoadCausers(ctx context.Context, e boil.ContextExecutor, singular bool, maybeAccount interface{}, mods queries.Applicator) error {
	var slice []*Account
	var object *Account
	...
	query := NewQuery(
		qm.From(`causer`),
		qm.WhereIn(`causer.account_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// SetCreatedByCauser of the account to the related item.
// Sets o.R.CreatedByCauser to related.
// Adds o to related.R.CreatedByAccounts.
func (o *Account) SetCreatedByCauser(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Causer) error {
	...
	if o.R == nil {
		o.R = &accountR{
			CreatedByCauser: related,
		}
	} else {
		o.R.CreatedByCauser = related
	}

	if related.R == nil {
		related.R = &causerR{
			CreatedByAccounts: AccountSlice{o},
		}
	} else {
		related.R.CreatedByAccounts = append(related.R.CreatedByAccounts, o)
	}
...
// Sets o.R.Account's Causers accordingly.
// Replaces o.R.Causers with related.
// Sets related.R.Account's Causers accordingly.
func (o *Account) SetCausers(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Causer) error {
	query := "update \"causer\" set \"account_id\" = null where \"account_id\" = $1"
...
func (o AccountSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor, hardDelete bool) (int64, error) {
	...
	if hardDelete {
		...
		sql = "DELETE FROM \"account\" WHERE " +
			strmangle.WhereInClause(string(dialect.LQ), string(dialect.RQ), 1, accountPrimaryKeyColumns, len(o))
	} else {
		currTime := time.Now().In(boil.GetLocation())
		for _, obj := range o {
			pkeyArgs := queries.ValuesFromMapping(reflect.Indirect(reflect.ValueOf(obj)), accountPrimaryKeyMapping)
		...
		sql = fmt.Sprintf("UPDATE \"account\" SET %s WHERE "+
			strmangle.WhereInClause(string(dialect.LQ), string(dialect.RQ), 2, accountPrimaryKeyColumns, len(o)),
			strmangle.SetParamNames("\"", "\"", 1, wl),
		)
